...
class BioAttention5_8(nn.Module):
    """
    5_1:biGRU+完整自注意力；
    5_2:最后cat拼接；
    ...
    def forward(self, x: torch.Tensor, mask, **kwargs) -> torch.Tensor:
        ...
        # o, _ = self.multi_head_attention(o1, o1, o1, None)  # bigru分开，使用mask # 因为前面使用了bigru，这里不再加mask
        # o = t = self.layernorm(o1 + o)
        # o = self.feedforward(o)
        # o = o + t
        # o = self.layernorm(o)
