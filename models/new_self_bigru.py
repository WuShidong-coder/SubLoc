...
class BioAttention5_4(nn.Module):
    """
    5_1:biGRU+完整自注意力；
    5_2:最后cat拼接；
    ...
    5_4:在自注意力中使用mask
    """
    def __init__(self, embeddings_dim: int = 1024, output_dim: int = 10, dropout=0.25, attention_dropout=0.2, n_heads=8):
        super(BioAttention5_4, self).__init__()
